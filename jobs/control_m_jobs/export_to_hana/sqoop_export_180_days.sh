...
sh $script_path/export_online_dpsm_new_vw/scripts/export_online_dpsm_new_vw_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_priceon_vw_all/scripts/export_priceon_vw_all_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_priceon_vw_priceon_lowest_certified/scripts/export_priceon_vw_priceon_lowest_certified_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_shelfon_vw_deal_keyword/scripts/export_shelfon_vw_deal_keyword_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_shelfon_vw_simple_doctormomming/scripts/export_shelfon_vw_simple_doctormomming_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_shelfon_vw_simple_reliu/scripts/export_shelfon_vw_simple_reliu_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_shelfon_vw_simple_top10/scripts/export_shelfon_vw_simple_top10_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_category_brand_report/scripts/export_tb_category_brand_report_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_category_brand_report_new/scripts/export_tb_category_brand_report_new_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_category_mnft_report/scripts/export_tb_category_mnft_report_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_category_mnft_report_new/scripts/export_tb_category_mnft_report_new_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_online_dpsm_d_report/scripts/export_tb_online_dpsm_d_report_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_tb_online_dpsm_p_report/scripts/export_tb_online_dpsm_p_report_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
...
sh $script_path/export_shelfon_vw_penetration_skucd_mapping/scripts/export_shelfon_vw_penetration_skucd_mapping_wrapper.sh 180 2>&1
if [ $? -ne 0 ];then
