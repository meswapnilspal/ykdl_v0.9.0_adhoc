...
--query "select year ,month ,classification ,classification2 ,biz_category ,vlt	,product_category_cd ,brand_cd ,
sub_brand_cd ,product_name ,sku_cd ,site ,
case 
when actual='true' then 1
when actual='false' then 0 end as actual,
target ,reg_date  from dbo.${table_name} where \$CONDITIONS" \
