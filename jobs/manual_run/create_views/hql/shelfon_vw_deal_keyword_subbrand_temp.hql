...
DROP VIEW IF EXISTS shelfon_vw_deal_keyword_subbrand_temp;

CREATE VIEW IF NOT EXISTS shelfon_vw_deal_keyword_subbrand_temp
...
AS
        ...
        and VCT.shelfon_category_seq not in (3989, 3990)                -- 3390: 타올 / 3989: 점보롤
                                                                          --오픈마켓 광고영역--
        and (
                (
        ...
        and depth_fullname ='유아/아동 > 기저귀' and SCD.site = 'street11' and rdate between '2017-01-01' and '2017-10-31'
;