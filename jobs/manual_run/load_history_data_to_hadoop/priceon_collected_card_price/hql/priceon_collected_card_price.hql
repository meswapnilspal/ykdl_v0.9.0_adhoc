...
DROP TABLE IF EXISTS ${hivedb}.priceon_collected_card_price_processed ;
...
insert into table ${hivedb}.priceon_collected_card_price_processed PARTITION (ingestion_date, ACTIVE_FLAG)
select 
 r.id
, r.priceon_data_seq
, r.unique_code
