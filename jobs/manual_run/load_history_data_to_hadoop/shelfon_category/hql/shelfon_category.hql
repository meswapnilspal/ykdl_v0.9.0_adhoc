...
DROP TABLE IF EXISTS ${hivedb}.shelfon_category_processed ; 
...
insert into table ${hivedb}.shelfon_category_processed PARTITION (ingestion_date , active_flag)
select 
...
MSCK REPAIR TABLE ${hivedb}.shelfon_category_processed;
